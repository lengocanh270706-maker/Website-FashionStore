...
<div class="col-12 col-md-3 col-lg-2 sidebar">
    <div class="collapse d-md-block" id="adminMenu">
        ...
        <nav class="d-flex flex-wrap flex-md-column gap-1">
            ...
            <a href="../products/index.php" class="active"><i class="bi bi-box"></i> Quản lý sản phẩm</a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if(!empty($row['main_image'])): ?>
                                                <img src="../../uploads/products/<?= htmlspecialchars($row['main_image']) ?>" class="prod-img shadow-sm" alt="">
                                            <?php else: ?>
